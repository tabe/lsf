...
This R package provides a simple interface to define a [location-scale family](http://www.randomservices.org/random/special/LocationScale.html) from a standard probability distribution.

## Installation

lsf has no releases yet.
